  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'>
      ...
      <nav className='w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50'>
        ...
        <ul className="hidden md:flex items-center gap-4 md:gap-6 lg:gap-8 rounded-full px-6 md:px-8 lg:px-10 py-2 md:py-3 bg-white shadow-md bg-opacity-50 backdrop-blur-sm ">
